...
from airflow-provider-fivetran.airflow-provider-fivetran.hooks.fivetran import FivetranHook
...
class FivetranOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        resp = hook.start_fivetran_sync(self.connector_id, self.poll_status_every_n_seconds)
